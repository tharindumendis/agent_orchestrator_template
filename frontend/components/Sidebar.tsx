            ...
            {isLoadingHistory ? (
              ...
              <div className="space-y-1">
                {historySessions.map((sid) => (
                  ...
                  >
                    <svg className="w-4 h-4 mr-3 opacity-70" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                    <span className="truncate">{sid}</span>
                  </div>
                ))}
              </div>
